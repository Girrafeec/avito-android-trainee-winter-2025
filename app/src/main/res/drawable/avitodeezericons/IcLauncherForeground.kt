...
public val AvitoDeezerIcons.IcLauncherForeground: ImageVector
    get() {
        ...
        _icLauncherForeground = Builder(name = "IcLauncherForeground", defaultWidth = 108.0.dp,
            ...
            path(fill = linearGradient(0.0f to Color(0x44000000), 1.0f to Color(0x00000000), start =
                    Offset(42.9492f,49.59793f), end = Offset(85.84757f,92.4963f)), stroke = null,
...
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = AvitoDeezerIcons.IcLauncherForeground, contentDescription = "")
    }
}
